	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 VertexPosition3588_g56186 = v.vertex.xyz;
				half3 Mesh_PivotsOS2291_g56186 = half3(0,0,0);
				float3 temp_output_2283_0_g56186 = ( VertexPosition3588_g56186 - Mesh_PivotsOS2291_g56186 );
				half3 VertexPos40_g56507 = temp_output_2283_0_g56186;
				...
				float Bounds_Height374_g56186 = _MaxBoundsInfo.y;
				half WorldData19_g56472 = ( Bounds_Height374_g56186 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g56472 = WorldData19_g56472;
				#else
				float staticSwitch14_g56472 = ObjectData20_g56472;
				#endif
				float Motion_Max_Bending1133_g56186 = staticSwitch14_g56472;
				...
				float3 vertexToFrag4224_g56186 = temp_output_114_0_g56500;
				half3 ObjectData20_g56464 = vertexToFrag4224_g56186;
				float3 vertexToFrag3890_g56186 = ase_worldPos;
				half3 WorldData19_g56464 = vertexToFrag3890_g56186;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g56464 = WorldData19_g56464;
				#else
				float3 staticSwitch14_g56464 = ObjectData20_g56464;
				#endif
				float3 ObjectPosition4223_g56186 = staticSwitch14_g56464;
				float3 Position83_g56474 = ObjectPosition4223_g56186;
				...
				half4 Global_Motion_Params3909_g56186 = lerpResult87_g56474;
				float4 break322_g56517 = Global_Motion_Params3909_g56186;
				...
				half Wind_Power_103106_g56186 = lerpResult376_g56517;
				float2 panner73_g56487 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4223_g56186).xz * TVE_NoiseParams.z ));
				...
				half Wind_Power2223_g56186 = Wind_Power369_g56517;
				float temp_output_167_0_g56487 = Wind_Power2223_g56186;
				...
				half Global_NoiseTex_R34_g56186 = break174_g56487.r;
				...
				half2 Wind_DirectionOS39_g56186 = (temp_output_339_0_g56517).xz;
				half Input_Speed62_g56504 = _MotionSpeed_10;
				float mulTime373_g56504 = _TimeParameters.x * Input_Speed62_g56504;
				float3 break111_g56453 = ObjectPosition4223_g56186;
				...
				#endif
				half Motion_Variation3073_g56186 = staticSwitch14_g56454;
				half Motion_Variation284_g56504 = ( _MotionVariation_10 * Motion_Variation3073_g56186 );
				...
				half Wind_Squash4479_g56186 = break322_g56517.w;
				half Input_WindSquash419_g56504 = Wind_Squash4479_g56186;
				half Input_WindPower327_g56504 = Wind_Power_103106_g56186;
				...
				half Mesh_Motion_1082_g56186 = v.ase_texcoord3.x;
				half2 Motion_10_Bending2258_g56186 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g56186 ) * Wind_Power_103106_g56186 * Global_NoiseTex_R34_g56186 * Wind_DirectionOS39_g56186 * lerpResult321_g56504 * Mesh_Motion_1082_g56186 );
				half Interaction_Amplitude4137_g56186 = _InteractionAmplitude;
				float3 Position83_g56496 = ObjectPosition4223_g56186;
				...
				half4 Global_React_Params4173_g56186 = lerpResult87_g56496;
				float4 break322_g56492 = Global_React_Params4173_g56186;
				half Interaction_Mask66_g56186 = break322_g56492.z;
				...
				half2 Interaction_DirectionOS4158_g56186 = (temp_output_339_0_g56492).xz;
				float lerpResult4494_g56186 = lerp( 1.0 , Mesh_Motion_1082_g56186 , _InteractionMaskValue);
				half2 Motion_10_Interaction53_g56186 = ( Interaction_Amplitude4137_g56186 * Motion_Max_Bending1133_g56186 * Interaction_Mask66_g56186 * Interaction_Mask66_g56186 * Interaction_DirectionOS4158_g56186 * lerpResult4494_g56186 );
				float2 lerpResult109_g56186 = lerp( Motion_10_Bending2258_g56186 , Motion_10_Interaction53_g56186 , ( Interaction_Mask66_g56186 * saturate( Interaction_Amplitude4137_g56186 ) ));
				float2 break143_g56186 = lerpResult109_g56186;
				half Motion_10_ZAxis190_g56186 = break143_g56186.y;
				half Angle44_g56507 = Motion_10_ZAxis190_g56186;
				...
				half Motion_10_XAxis216_g56186 = break143_g56186.x;
				half Angle44_g56511 = -Motion_10_XAxis216_g56186;
				float3 Vertex_Motion_Object833_g56186 = ( VertexPosRotationAxis50_g56511 + ( VertexPosOtherAxis82_g56511 * cos( Angle44_g56511 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g56511 ) * sin( Angle44_g56511 ) ) );
				float3 temp_output_3474_0_g56186 = ( VertexPosition3588_g56186 - Mesh_PivotsOS2291_g56186 );
				float3 appendResult2043_g56186 = (float3(Motion_10_XAxis216_g56186 , 0.0 , Motion_10_ZAxis190_g56186));
				float3 Vertex_Motion_World1118_g56186 = ( temp_output_3474_0_g56186 + appendResult2043_g56186 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g56186 = Vertex_Motion_World1118_g56186;
				#else
				float3 staticSwitch3312_g56186 = ( Vertex_Motion_Object833_g56186 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g56186 = break322_g56492.w;
				float lerpResult346_g56186 = lerp( 1.0 , Global_Vertex_Size174_g56186 , _GlobalSize);
				float3 appendResult3480_g56186 = (float3(lerpResult346_g56186 , lerpResult346_g56186 , lerpResult346_g56186));
				half3 ObjectData20_g56469 = appendResult3480_g56186;
				...
				#endif
				half3 Vertex_Size1741_g56186 = staticSwitch14_g56469;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g56186 = _Vector5;
				half3 Grass_Coverage2661_g56186 = half3(0,0,0);
				float3 Final_VertexPosition890_g56186 = ( ( ( staticSwitch3312_g56186 * Vertex_Size1741_g56186 * Vertex_SizeFade1740_g56186 ) + Mesh_PivotsOS2291_g56186 + Grass_Coverage2661_g56186 ) + _DisableSRPBatcher );
				
				float temp_output_7_0_g56494 = _GradientMinValue;
				float4 lerpResult2779_g56186 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( v.ase_color.a - temp_output_7_0_g56494 ) / ( _GradientMaxValue - temp_output_7_0_g56494 ) ) ));
				half3 Gradient_Tint2784_g56186 = (lerpResult2779_g56186).rgb;
				float3 vertexToFrag11_g56476 = Gradient_Tint2784_g56186;
				o.ase_texcoord7.xyz = vertexToFrag11_g56476;
				float3 temp_cast_11 = (_NoiseScaleValue).xxx;
				float3 WorldPosition3905_g56186 = vertexToFrag3890_g56186;
				float temp_output_7_0_g56468 = _NoiseMinValue;
				half Noise_Mask3162_g56186 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_11 * WorldPosition3905_g56186 * 0.1 ), 0.0) ).r - temp_output_7_0_g56468 ) / ( _NoiseMaxValue - temp_output_7_0_g56468 ) ) );
				float4 lerpResult2800_g56186 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g56186);
				half3 Noise_Tint2802_g56186 = (lerpResult2800_g56186).rgb;
				float3 vertexToFrag11_g56475 = Noise_Tint2802_g56186;
				...
				float3 Position58_g56495 = WorldPosition3905_g56186;
				...
				half Global_ColorsTex_A1701_g56186 = (lerpResult88_g56495).a;
				float vertexToFrag11_g56486 = Global_ColorsTex_A1701_g56186;
				o.ase_texcoord7.w = vertexToFrag11_g56486;
				o.ase_texcoord10.xyz = vertexToFrag3890_g56186;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g56186;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half Leaves_Mask4511_g56186 = 1.0;
				float3 lerpResult4521_g56186 = lerp( float3( 1,1,1 ) , ( vertexToFrag11_g56476 * vertexToFrag11_g56475 * float3(1,1,1) ) , Leaves_Mask4511_g56186);
				float3 lerpResult4519_g56186 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g56186);
				float2 vertexToFrag11_g56515 = IN.ase_texcoord9.xy;
				half2 Main_UVs15_g56186 = vertexToFrag11_g56515;
				float4 tex2DNode29_g56186 = tex2D( _MainAlbedoTex, Main_UVs15_g56186 );
				half3 Main_Albedo99_g56186 = ( lerpResult4519_g56186 * (tex2DNode29_g56186).rgb );
				half3 Blend_Albedo265_g56186 = Main_Albedo99_g56186;
				half3 Blend_AlbedoTinted2808_g56186 = ( lerpResult4521_g56186 * Blend_Albedo265_g56186 );
				float dotResult3616_g56186 = dot( Blend_AlbedoTinted2808_g56186 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g56186).xxx;
				float vertexToFrag11_g56486 = IN.ase_texcoord7.w;
				half Global_Colors_Influence3668_g56186 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56186 = lerp( Blend_AlbedoTinted2808_g56186 , temp_cast_0 , Global_Colors_Influence3668_g56186);
				float3 vertexToFrag3890_g56186 = IN.ase_texcoord10.xyz;
				float3 WorldPosition3905_g56186 = vertexToFrag3890_g56186;
				float3 Position58_g56495 = WorldPosition3905_g56186;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				...
				half3 Global_ColorsTex_RGB1700_g56186 = (lerpResult88_g56495).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g56465 = 2.0;
				#else
				float staticSwitch1_g56465 = 4.594794;
				#endif
				half3 Global_Colors1954_g56186 = ( Global_ColorsTex_RGB1700_g56186 * staticSwitch1_g56465 );
				half Global_Colors_Value3650_g56186 = _GlobalColors;
				float4 tex2DNode35_g56186 = tex2D( _MainMaskTex, Main_UVs15_g56186 );
				half Main_Mask57_g56186 = tex2DNode35_g56186.b;
				float temp_output_7_0_g56483 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g56186 = saturate( ( ( Main_Mask57_g56186 - temp_output_7_0_g56483 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g56483 ) ) );
				float3 lerpResult3628_g56186 = lerp( Blend_AlbedoTinted2808_g56186 , ( lerpResult3618_g56186 * Global_Colors1954_g56186 ) , ( Global_Colors_Value3650_g56186 * Global_Colors_Mask3692_g56186 ));
				half3 Blend_AlbedoColored863_g56186 = lerpResult3628_g56186;
				float3 temp_output_799_0_g56186 = (_SubsurfaceColor).rgb;
				float dotResult3930_g56186 = dot( temp_output_799_0_g56186 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g56186).xxx;
				float3 lerpResult3932_g56186 = lerp( temp_output_799_0_g56186 , temp_cast_3 , Global_Colors_Influence3668_g56186);
				float3 lerpResult3942_g56186 = lerp( temp_output_799_0_g56186 , ( lerpResult3932_g56186 * Global_Colors1954_g56186 ) , ( Global_Colors_Value3650_g56186 * Global_Colors_Mask3692_g56186 ));
				half3 Subsurface_Color1722_g56186 = lerpResult3942_g56186;
				half MainLight_Subsurface4041_g56186 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g56186 = ( _SubsurfaceValue * MainLight_Subsurface4041_g56186 );
				float temp_output_7_0_g56516 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g56186 = saturate( ( ( Main_Mask57_g56186 - temp_output_7_0_g56516 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g56516 ) ) );
				half3 Subsurface_Transmission884_g56186 = ( Subsurface_Color1722_g56186 * Subsurface_Intensity1752_g56186 * Subsurface_Mask1557_g56186 );
				half3 MainLight_Direction3926_g56186 = TVE_MainLightDirection;
				float3 normalizeResult2169_g56186 = normalize( WorldViewDirection );
				float3 ViewDir_Normalized3963_g56186 = normalizeResult2169_g56186;
				float dotResult785_g56186 = dot( -MainLight_Direction3926_g56186 , ViewDir_Normalized3963_g56186 );
				float saferPower1624_g56186 = max( (dotResult785_g56186*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g56186 = 0.0;
				#else
				float staticSwitch1602_g56186 = ( pow( saferPower1624_g56186 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g56186 = staticSwitch1602_g56186;
				half3 Subsurface_Scattering1693_g56186 = ( Subsurface_Transmission884_g56186 * Blend_AlbedoColored863_g56186 * Mask_Subsurface_View782_g56186 );
				half3 Blend_AlbedoAndSubsurface149_g56186 = ( Blend_AlbedoColored863_g56186 + Subsurface_Scattering1693_g56186 );
				half3 Global_OverlayColor1758_g56186 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g56186 = tex2DNode29_g56186.g;
				float3 Position82_g56460 = WorldPosition3905_g56186;
				...
				half Global_Extras_Overlay156_g56186 = break89_g56460.b;
				float temp_output_1025_0_g56186 = ( _GlobalOverlay * Global_Extras_Overlay156_g56186 );
				half Overlay_Commons1365_g56186 = temp_output_1025_0_g56186;
				float temp_output_7_0_g56499 = _OverlayMaskMinValue;
				half Overlay_Mask269_g56186 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g56186 ) * Overlay_Commons1365_g56186 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				float3 lerpResult336_g56186 = lerp( Blend_AlbedoAndSubsurface149_g56186 , Global_OverlayColor1758_g56186 , Overlay_Mask269_g56186);
				half3 Final_Albedo359_g56186 = lerpResult336_g56186;
				
				float3 unpack4112_g56186 = UnpackNormalScale( tex2D( _MainNormalTex, Main_UVs15_g56186 ), _MainNormalValue );
				unpack4112_g56186.z = lerp( 1, unpack4112_g56186.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g56186 = unpack4112_g56186;
				float3 temp_output_13_0_g56506 = Main_Normal137_g56186;
				float3 switchResult12_g56506 = (((ase_vface>0)?(temp_output_13_0_g56506):(( temp_output_13_0_g56506 * _render_normals_options ))));
				half3 Blend_Normal312_g56186 = switchResult12_g56506;
				half3 Final_Normal366_g56186 = Blend_Normal312_g56186;
				
				float4 temp_output_4214_0_g56186 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g56467 = IN.ase_texcoord9.zw;
				half2 Emissive_UVs2468_g56186 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56186 = break89_g56460.r;
				float lerpResult4206_g56186 = lerp( 1.0 , Global_Extras_Emissive4203_g56186 , _GlobalEmissive);
				half3 Final_Emissive2476_g56186 = ( (( temp_output_4214_0_g56186 * tex2D( _EmissiveTex, Emissive_UVs2468_g56186 ) )).rgb * lerpResult4206_g56186 );
				
				float3 temp_cast_7 = (( 0.04 * _RenderSpecular )).xxx;
				
				half Main_Smoothness227_g56186 = ( tex2DNode35_g56186.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g56186 = Main_Smoothness227_g56186;
				half Global_OverlaySmoothness311_g56186 = TVE_OverlaySmoothness;
				float lerpResult343_g56186 = lerp( Blend_Smoothness314_g56186 , Global_OverlaySmoothness311_g56186 , Overlay_Mask269_g56186);
				half Final_Smoothness371_g56186 = lerpResult343_g56186;
				half Global_Extras_Wetness305_g56186 = break89_g56460.g;
				float lerpResult3673_g56186 = lerp( 0.0 , Global_Extras_Wetness305_g56186 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g56186 = saturate( ( Final_Smoothness371_g56186 + lerpResult3673_g56186 ) );
				
				float lerpResult240_g56186 = lerp( 1.0 , tex2DNode35_g56186.g , _MainOcclusionValue);
				half Main_Occlusion247_g56186 = lerpResult240_g56186;
				half Blend_Occlusion323_g56186 = Main_Occlusion247_g56186;
				
				float localCustomAlphaClip3735_g56186 = ( 0.0 );
				float3 normalizeResult3971_g56186 = normalize( cross( ddy( WorldPosition ) , ddx( WorldPosition ) ) );
				float3 NormalsWS_Derivates3972_g56186 = normalizeResult3971_g56186;
				float dotResult2161_g56186 = dot( ViewDir_Normalized3963_g56186 , NormalsWS_Derivates3972_g56186 );
				float dotResult2212_g56186 = dot( ViewDir_Normalized3963_g56186 , float3(0,1,0) );
				half Mask_HView2656_g56186 = dotResult2212_g56186;
				float lerpResult2221_g56186 = lerp( _FadeHorizontalValue , _FadeVerticalValue , Mask_HView2656_g56186);
				float lerpResult3992_g56186 = lerp( 1.0 , abs( dotResult2161_g56186 ) , lerpResult2221_g56186);
				half Fade_Billboard2175_g56186 = lerpResult3992_g56186;
				half Final_AlphaFade3727_g56186 = ( 1.0 * Fade_Billboard2175_g56186 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g56186;
				float Main_Alpha316_g56186 = ( _MainColor.a * tex2DNode29_g56186.a );
				half AlphaTreshold2132_g56186 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g56186 = ( Main_Alpha316_g56186 - ( AlphaTreshold2132_g56186 - 0.5 ) );
				#else
				float staticSwitch3792_g56186 = Main_Alpha316_g56186;
				#endif
				half Final_Alpha3754_g56186 = staticSwitch3792_g56186;
				float temp_output_661_0_g56186 = ( saturate( ( temp_output_41_0_g56470 + ( temp_output_41_0_g56470 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g56186 ) ).r ) ) ) * Final_Alpha3754_g56186 );
				float Alpha3735_g56186 = temp_output_661_0_g56186;
				float Treshold3735_g56186 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g56186 - Treshold3735_g56186);
				#endif
				}
				half Final_Clip914_g56186 = saturate( Alpha3735_g56186 );
				
				float3 Albedo = Final_Albedo359_g56186;
				float3 Normal = Final_Normal366_g56186;
				float3 Emission = Final_Emissive2476_g56186;
				float3 Specular = temp_cast_7;
				float Metallic = 0;
				float Smoothness = Final_SmoothnessAndWetness4130_g56186;
				float Occlusion = Blend_Occlusion323_g56186;
				float Alpha = Final_Clip914_g56186;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
				float3 BakedGI = 0;
				float3 RefractionColor = 1;
				float RefractionIndex = 1;
				float3 Transmission = Subsurface_Transmission884_g56186;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				o.ase_texcoord2.xyz = vertexToFrag3890_g56186;
						 ...
						 ) : SV_TARGET
			{
				...
				float3 normalizeResult2169_g56186 = normalize( ase_worldViewDir );
				float3 ViewDir_Normalized3963_g56186 = normalizeResult2169_g56186;
				float3 normalizeResult3971_g56186 = normalize( cross( ddy( WorldPosition ) , ddx( WorldPosition ) ) );
				float3 NormalsWS_Derivates3972_g56186 = normalizeResult3971_g56186;
				float dotResult2161_g56186 = dot( ViewDir_Normalized3963_g56186 , NormalsWS_Derivates3972_g56186 );
				...
				half Final_AlphaFade3727_g56186 = ( 1.0 * Fade_Billboard2175_g56186 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g56186;
				float3 vertexToFrag3890_g56186 = IN.ase_texcoord2.xyz;
				float3 WorldPosition3905_g56186 = vertexToFrag3890_g56186;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord5.xyz = vertexToFrag3890_g56186;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half Global_Colors_Influence3668_g56186 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56186 = lerp( Blend_AlbedoTinted2808_g56186 , temp_cast_0 , Global_Colors_Influence3668_g56186);
				float3 vertexToFrag3890_g56186 = IN.ase_texcoord5.xyz;
				float3 WorldPosition3905_g56186 = vertexToFrag3890_g56186;
				float3 Position58_g56495 = WorldPosition3905_g56186;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
...
Node;AmplifyShaderEditor.FunctionNode;398;-1536,-896;Inherit;False;Compile Core;-1;;56523;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;396;-1856,384;Inherit;False;Define Pipeline Universal;-1;;56522;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.FunctionNode;397;-1344,-896;Inherit;False;Compile All Shaders;-1;;56520;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=9381FEEEF2915DB3EC0BB768513AFACE32FC5368
