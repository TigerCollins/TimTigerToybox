	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 Vertex_Motion_Object833_g56251 = ( ( VertexPosRotationAxis50_g56481 + ( VertexPosOtherAxis82_g56481 * cos( Angle44_g56481 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g56481 ) * sin( Angle44_g56481 ) ) ) + Motion_20_Vertical4280_g56251 + Motion_20_Squash4418_g56251 );
				...
				float3 Vertex_Motion_World1118_g56251 = ( ( temp_output_3474_0_g56251 + appendResult2043_g56251 ) + appendResult2047_g56251 + Motion_20_Vertical4280_g56251 + Motion_20_Squash4418_g56251 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				float2 appendResult21_g56459 = (float2(v.texcoord.z , v.texcoord.w));
				float2 Mesh_DetailCoord3_g56251 = appendResult21_g56459;
				float2 vertexToFrag11_g56505 = ( ( Mesh_DetailCoord3_g56251 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord7.zw = vertexToFrag11_g56505;
				half Mesh_DetailMask90_g56251 = v.ase_color.b;
				float vertexToFrag11_g56471 = ( ( Mesh_DetailMask90_g56251 - 0.5 ) + _DetailMeshValue );
				o.ase_texcoord8.x = vertexToFrag11_g56471;
				o.ase_texcoord8.yzw = vertexToFrag3890_g56251;
				...
				float3 lerpResult2945_g56251 = lerp( (_VertexOcclusionColor).rgb , temp_cast_11 , saturate( ( ( Mesh_Occlusion318_g56251 - temp_output_7_0_g56463 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g56463 ) ) ));
				...
				o.ase_texcoord10.xy = vertexToFrag11_g56467;
				...
				o.ase_texcoord9.w = vertexToFrag11_g56491;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float3 lerpResult4521_g56251 = lerp( float3( 1,1,1 ) , ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) ) , Leaves_Mask4511_g56251);
				...
				half2 Second_UVs17_g56251 = vertexToFrag11_g56505;
				half3 Second_Albedo153_g56251 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g56251 ) )).rgb;
				...
				float temp_output_3919_0_g56251 = vertexToFrag11_g56471;
				half Blend_Source1540_g56251 = temp_output_3919_0_g56251;
				float4 tex2DNode35_g56251 = tex2D( _MainMaskTex, Main_UVs15_g56251 );
				half Main_Mask57_g56251 = tex2DNode35_g56251.b;
				float4 tex2DNode33_g56251 = tex2D( _SecondMaskTex, Second_UVs17_g56251 );
				half Second_Mask81_g56251 = tex2DNode33_g56251.b;
				float lerpResult1327_g56251 = lerp( Main_Mask57_g56251 , Second_Mask81_g56251 , _DetailMaskMode);
				float lerpResult4058_g56251 = lerp( lerpResult1327_g56251 , ( 1.0 - lerpResult1327_g56251 ) , _DetailMaskInvertMode);
				float temp_output_7_0_g56466 = _DetailBlendMinValue;
				half Mask_Detail147_g56251 = saturate( ( ( saturate( ( Blend_Source1540_g56251 + ( Blend_Source1540_g56251 * lerpResult4058_g56251 ) ) ) - temp_output_7_0_g56466 ) / ( _DetailBlendMaxValue - temp_output_7_0_g56466 ) ) );
				float3 lerpResult235_g56251 = lerp( Main_Albedo99_g56251 , ( Main_Albedo99_g56251 * Second_Albedo153_g56251 * staticSwitch1_g56484 ) , Mask_Detail147_g56251);
				float3 lerpResult208_g56251 = lerp( Main_Albedo99_g56251 , Second_Albedo153_g56251 , Mask_Detail147_g56251);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g56251 = lerpResult235_g56251;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g56251 = lerpResult208_g56251;
				#else
				float3 staticSwitch4062_g56251 = lerpResult235_g56251;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g56251 = Main_Albedo99_g56251;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g56251 = staticSwitch4062_g56251;
				#else
				float3 staticSwitch255_g56251 = Main_Albedo99_g56251;
				#endif
				half3 Blend_Albedo265_g56251 = staticSwitch255_g56251;
				half3 Blend_AlbedoTinted2808_g56251 = ( lerpResult4521_g56251 * Blend_Albedo265_g56251 );
				half3 Blend_AlbedoColored863_g56251 = Blend_AlbedoTinted2808_g56251;
				half3 Blend_AlbedoAndSubsurface149_g56251 = Blend_AlbedoColored863_g56251;
				...
				half Second_AlbedoTex_G3581_g56251 = (tex2D( _SecondAlbedoTex, Second_UVs17_g56251 )).g;
				float lerpResult3579_g56251 = lerp( Main_AlbedoTex_G3526_g56251 , Second_AlbedoTex_G3581_g56251 , Mask_Detail147_g56251);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch3574_g56251 = Main_AlbedoTex_G3526_g56251;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch3574_g56251 = lerpResult3579_g56251;
				#else
				float staticSwitch3574_g56251 = Main_AlbedoTex_G3526_g56251;
				#endif
				float3 vertexToFrag3890_g56251 = IN.ase_texcoord8.yzw;
				...
				half Overlay_Commons1365_g56251 = temp_output_1025_0_g56251;
				float temp_output_7_0_g56499 = _OverlayMaskMinValue;
				half Overlay_Mask269_g56251 = saturate( ( ( ( ( ( lerpResult3567_g56251 * 0.5 ) + staticSwitch3574_g56251 ) * Overlay_Commons1365_g56251 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				...
				float3 unpack4114_g56251 = UnpackNormalScale( tex2D( _SecondNormalTex, Second_UVs17_g56251 ), _SecondNormalValue );
				unpack4114_g56251.z = lerp( 1, unpack4114_g56251.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g56251 = unpack4114_g56251;
				float3 lerpResult230_g56251 = lerp( float3( 0,0,1 ) , Second_Normal179_g56251 , Mask_Detail147_g56251);
				float3 lerpResult3372_g56251 = lerp( float3( 0,0,1 ) , Main_Normal137_g56251 , _DetailNormalValue);
				float3 lerpResult3376_g56251 = lerp( Main_Normal137_g56251 , BlendNormal( lerpResult3372_g56251 , Second_Normal179_g56251 ) , Mask_Detail147_g56251);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g56251 = BlendNormal( Main_Normal137_g56251 , lerpResult230_g56251 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g56251 = lerpResult3376_g56251;
				#else
				float3 staticSwitch4063_g56251 = BlendNormal( Main_Normal137_g56251 , lerpResult230_g56251 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch267_g56251 = Main_Normal137_g56251;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g56251 = staticSwitch4063_g56251;
				#else
				float3 staticSwitch267_g56251 = Main_Normal137_g56251;
				#endif
				float3 temp_output_13_0_g56506 = staticSwitch267_g56251;
				...
				float2 vertexToFrag11_g56467 = IN.ase_texcoord10.xy;
				...
				half Second_Smoothness236_g56251 = ( tex2DNode33_g56251.a * _SecondSmoothnessValue );
				float lerpResult266_g56251 = lerp( Main_Smoothness227_g56251 , Second_Smoothness236_g56251 , Mask_Detail147_g56251);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g56251 = Main_Smoothness227_g56251;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g56251 = lerpResult266_g56251;
				#else
				float staticSwitch4065_g56251 = Main_Smoothness227_g56251;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch297_g56251 = Main_Smoothness227_g56251;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g56251 = staticSwitch4065_g56251;
				#else
				float staticSwitch297_g56251 = Main_Smoothness227_g56251;
				#endif
				half Blend_Smoothness314_g56251 = staticSwitch297_g56251;
				...
				float lerpResult239_g56251 = lerp( 1.0 , tex2DNode33_g56251.g , _SecondOcclusionValue);
				half Second_Occlusion251_g56251 = lerpResult239_g56251;
				float lerpResult294_g56251 = lerp( Main_Occlusion247_g56251 , Second_Occlusion251_g56251 , Mask_Detail147_g56251);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g56251 = Main_Occlusion247_g56251;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g56251 = lerpResult294_g56251;
				#else
				float staticSwitch4066_g56251 = Main_Occlusion247_g56251;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch310_g56251 = Main_Occlusion247_g56251;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g56251 = staticSwitch4066_g56251;
				#else
				float staticSwitch310_g56251 = Main_Occlusion247_g56251;
				#endif
				half Blend_Occlusion323_g56251 = staticSwitch310_g56251;
				
				float localCustomAlphaClip3735_g56251 = ( 0.0 );
				float vertexToFrag11_g56491 = IN.ase_texcoord9.w;
				half Fade_Camera3743_g56251 = vertexToFrag11_g56491;
				half Final_AlphaFade3727_g56251 = ( 1.0 * Fade_Camera3743_g56251 );
				...
				float staticSwitch3792_g56251 = ( Main_Alpha316_g56251 - ( AlphaTreshold2132_g56251 - 0.5 ) );
				#else
				float staticSwitch3792_g56251 = Main_Alpha316_g56251;
				#endif
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult21_g56459 = (float2(v.ase_texcoord.z , v.ase_texcoord.w));
				float2 Mesh_DetailCoord3_g56251 = appendResult21_g56459;
				float2 vertexToFrag11_g56505 = ( ( Mesh_DetailCoord3_g56251 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				...
				o.ase_texcoord6.xyz = vertexToFrag3890_g56251;
				float3 temp_cast_11 = (1.0).xxx;
				float Mesh_Occlusion318_g56251 = v.ase_color.g;
				float temp_output_7_0_g56463 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g56251 = lerp( (_VertexOcclusionColor).rgb , temp_cast_11 , saturate( ( ( Mesh_Occlusion318_g56251 - temp_output_7_0_g56463 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g56463 ) ) ));
				...
				o.ase_texcoord8.xy = vertexToFrag11_g56467;
				
				float temp_output_7_0_g56513 = TVE_CameraFadeStart;
				float saferPower3976_g56251 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g56513 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g56513 ) ) ) , 0.0001 );
				float temp_output_3976_0_g56251 = pow( saferPower3976_g56251 , _FadeCameraValue );
				float vertexToFrag11_g56491 = temp_output_3976_0_g56251;
				o.ase_texcoord4.w = vertexToFrag11_g56491;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float staticSwitch3574_g56251 = Main_AlbedoTex_G3526_g56251;
				#endif
				float3 vertexToFrag3890_g56251 = IN.ase_texcoord6.xyz;
				float3 WorldPosition3905_g56251 = vertexToFrag3890_g56251;
				float3 Position82_g56460 = WorldPosition3905_g56251;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
				...
				float4 temp_output_4214_0_g56251 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g56467 = IN.ase_texcoord8.xy;
				half2 Emissive_UVs2468_g56251 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56251 = break89_g56460.r;
				float lerpResult4206_g56251 = lerp( 1.0 , Global_Extras_Emissive4203_g56251 , _GlobalEmissive);
				half3 Final_Emissive2476_g56251 = ( (( temp_output_4214_0_g56251 * tex2D( _EmissiveTex, Emissive_UVs2468_g56251 ) )).rgb * lerpResult4206_g56251 );
				...
				float localCustomAlphaClip3735_g56251 = ( 0.0 );
				float vertexToFrag11_g56491 = IN.ase_texcoord4.w;
				half Fade_Camera3743_g56251 = vertexToFrag11_g56491;
				half Final_AlphaFade3727_g56251 = ( 1.0 * Fade_Camera3743_g56251 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g56251;
				float Main_Alpha316_g56251 = ( _MainColor.a * tex2DNode29_g56251.a );
...
Node;AmplifyShaderEditor.FunctionNode;376;-1536,-896;Inherit;False;Compile Core;-1;;56522;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;375;-1344,-896;Inherit;False;Compile All Shaders;-1;;56521;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=823F8C2DA2F0C5D5939A869C490AC964CC200709
